...
////// Specular:
                ...
                float4 node_3422 = _Time;
                float node_2191 = 0.0;
                float node_2846 = (1.0 - saturate((node_2191 + ( (node_6398 - _FoamMin) * (1.0 - node_2191) ) / (_FoamMax - _FoamMin))));
                float3 node_7911 = saturate(((((node_1638*float3((i.uv0+node_3422.g*float2(0.01,0.01)),0.0))*node_2846)*_FoamPower)+pow(node_2846,5.0)));
...
////// Specular:
                ...
                float node_6398 = saturate((saturate((sceneZ-partZ)/_Depth)/0.5*dot(viewDirection,i.normalDir)+0.5));
                float3 node_1638 = lerp(_ColorA.rgb,_ColorB.rgb,node_6398);
                float4 node_1917 = _Time;
                float node_2191 = 0.0;
                float node_2846 = (1.0 - saturate((node_2191 + ( (node_6398 - _FoamMin) * (1.0 - node_2191) ) / (_FoamMax - _FoamMin))));
                float3 node_7911 = saturate(((((node_1638*float3((i.uv0+node_1917.g*float2(0.01,0.01)),0.0))*node_2846)*_FoamPower)+pow(node_2846,5.0)));
                float3 diffuseColor = saturate((node_1638+node_7911)); // Need this for specular when using metallic
                diffuseColor = DiffuseAndSpecularFromMetallic( diffuseColor, specularColor, specularColor, specularMonochrome );
                specularMonochrome = 1.0-specularMonochrome;
                float NdotV = abs(dot( normalDirection, viewDirection ));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_6398 = saturate((saturate((sceneZ-partZ)/_Depth)/0.5*dot(viewDirection,i.normalDir)+0.5));
                float3 node_1638 = lerp(_ColorA.rgb,_ColorB.rgb,node_6398);
                float4 node_9240 = _Time;
                float node_2191 = 0.0;
                float node_2846 = (1.0 - saturate((node_2191 + ( (node_6398 - _FoamMin) * (1.0 - node_2191) ) / (_FoamMax - _FoamMin))));
                float3 node_7911 = saturate(((((node_1638*float3((i.uv0+node_9240.g*float2(0.01,0.01)),0.0))*node_2846)*_FoamPower)+pow(node_2846,5.0)));
